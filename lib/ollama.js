...
const ANALYSIS_TIMEOUT = parseInt(process.env.ANALYSIS_TIMEOUT || '120000', 10); // 2min default
...
async function analyzeSession(messages) {
  ...
  // Truncate if too long (keep ~8000 chars for context window)
  const maxConvLength = 8000;
...
module.exports = { analyzeSession, analyzeBatch, checkOllamaStatus, OLLAMA_MODEL };
